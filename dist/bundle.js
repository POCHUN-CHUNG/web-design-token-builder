...
exports.toFlatFormat = toFlatFormat; function toFlatFormat(dtcg) {
  ...
  define("./src/export/toText.js", function(__require, exports) {
...
exports.stateToText = stateToText; function stateToText(state) {
  let lines = [];
  lines.push("========================================");
...
const { stateToText } = __require("./export/toText.js");
